...
public class HannahLeeBot extends TelegramLongPollingBot {
		...
		if(update.hasMessage()) {
			if(update.getMessage().hasText()) {
				...
				for(int i = 0; i < text.length()-1; i++) {
					...
					if(text.substring(i, i+2).equals("ly")){
						print("found ly at index: " + i, 0);
					...
					if(i < text.length()-2) {
						if(text.substring(i, i+3).equals("lee")){
							print("found lee at index: " + i, 0);
	...
	public String getBotToken() {
		return "1035301744:AAErBcAoeO9PD2DWv9CdG7IaoHNVXpHXR9c";
	}
